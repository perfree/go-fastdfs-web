...
public interface PeersMapper {
     ...
     * @param peers
     */
    @Insert("INSERT INTO t_peers(name,groupName, serverAddress,showAddress, createTime) VALUES(#{peers.name},#{peers.groupName}, #{peers.serverAddress},#{peers.showAddress}, #{peers.createTime})")
     ...
     * @return int
     */
    @Update("UPDATE t_peers SET name=#{name},groupName=#{groupName},serverAddress=#{serverAddress},showAddress=#{showAddress} WHERE id=#{id}")
